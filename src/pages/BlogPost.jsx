    ...
    return (
      <section className="py-16 bg-bg text-ink">
        <div className="max-w-5xl mx-auto px-4">
          <h1 className="font-display text-3xl mb-2">Artikulli nuk u gjet</h1>
          <p className="text-ink/70 mb-4">Kontrollo linkun ose kthehu te lista e artikujve.</p>
          <Link to="/blog" className="btn-ghost">← Kthehu te Blogu</Link>
        </div>
      </section>
    );
  }
    ...
    <>
      ...
      <section className="relative bg-bg text-ink">
        <div className="shine-wrap">
          <img src={post.cover} alt={post.title} className="w-full h-[42vh] md:h-[50vh] object-cover" />
        </div>
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 w-full max-w-5xl px-4">
          <div className="flex flex-wrap items-end gap-3">
            <h1 className="font-display text-3xl md:text-5xl gradient-text drop-shadow">{post.title}</h1>
